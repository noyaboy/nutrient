...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('20:30 睡前：熱水澡 + 酪蛋白 + 補充品', '熱水澡 40-42°C 10-15 分鐘（睡前 60-90 分鐘）。酪蛋白 ~32g 粉（≈25g 蛋白）+ 甘胺酸 3g + 蘇糖酸鎂 + 甘胺酸鎂 + Ashwagandha 600mg（8 週用 / 4 週停，停用期改服紅景天 500mg。第 6-8 週留意情緒冷漠或早晨無力）', 'daily', '補充品', 15, 1, true),
  ...
  -- === All-day items ===
  ('全天 蛋白質 146g+ 目標', '每餐 30-40g 蛋白（蛋、魚、雞胸、乳清、酪蛋白）。每日 4-5 餐均勻分配，總計 146g+（2.0g/kg）。每餐達到亮氨酸門檻 2.5-3g', 'daily', '飲食', 19, 1, true),
  ...
  ('全天 飲水 3-3.5L', '07:05 起床 500ml（碘鹽+檸檬）→ 08:00 訓練中 500ml → 10:00 訓練後補水 250ml → 11:00 綠茶 500ml → 13:00 隨餐 250ml → 15:00 下午補水 250ml → 18:00 隨餐 250ml → 20:30 酪蛋白沖泡 250ml。有氧日訓練中改用電解質粉。尿液淡黃色為適當水合指標', 'daily', '飲食', 25, 1, true);
