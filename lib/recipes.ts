...
export const lunchRecipes: Recipe[] = [
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 45,
    macros: { protein: 43, carbs: 83, fat: 8, calories: 611 },
    ingredients: [
  ...
  },
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 40,
    macros: { protein: 42, carbs: 63, fat: 8, calories: 523 },
    ingredients: [
      { name: '雞胸肉', amount: '100g' },
  ...
  },
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 45,
    macros: { protein: 44, carbs: 85, fat: 13, calories: 650 },
    ingredients: [
      { name: '雞胸肉', amount: '80g' },
      { name: '雞蛋', amount: '1顆' },
      { name: '冷凍綠花椰菜', amount: '100g' },
  ...
  },
  {
    ...
    tips: '酪梨不蒸，最後擺盤保留營養。花椰菜切碎靜置後再蒸可提升蘿蔔硫素',
  },
];
...
export const dinnerRecipes: Recipe[] = [
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 45,
    macros: { protein: 44, carbs: 86, fat: 8, calories: 618 },
    ingredients: [
      { name: '雞胸肉', amount: '100g' },
      { name: '冷凍綠花椰菜', amount: '200g' },
      { name: '糙米', amount: '100g（生重）' },
  ...
  },
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 40,
    macros: { protein: 43, carbs: 77, fat: 8, calories: 580 },
    ingredients: [
      { name: '雞胸肉', amount: '100g' },
      { name: '冷凍綠花椰菜', amount: '100g' },
      { name: '菠菜', amount: '100g' },
  ...
  },
  {
    ...
    cookingMethod: '電子鍋',
    prepTime: 45,
    macros: { protein: 45, carbs: 86, fat: 9, calories: 625 },
    ingredients: [
      { name: '雞胸肉', amount: '100g' },
      { name: '冷凍綠花椰菜', amount: '100g' },
      { name: '泡菜', amount: '80g' },
