...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count) VALUES
  ...
  ('09:00 訓練後早餐 + 補充品', '乳清蛋白 ~40g 粉（≈36g 蛋白）+ 肌酸 5g + 碳水 80-105g；魚油 3 顆、D3 2000IU（5+2 週末休息）、鈣+D3+K2 1 錠（5+2）、維他命 C、葉黃素 20mg', 'daily', '飲食', 5, 1),
  ('13:00 午餐', '蛋白質 40-50g + 十字花科蔬菜', 'daily', '飲食', 7, 1),
  ('14:00 銅 2mg', '與鋅間隔 4hr+（鋅在 18:00 晚餐服用）。5+2：週一至五服用，週末休息', 'daily', '補充品', 8, 1),
  ('18:00 晚餐 + 鋅 25mg', '蛋白質 + 十字花科蔬菜 + 原型碳水。進食順序：纖維→蛋白→碳水。鋅 25mg 隨餐服用（5+2：週一至五，週末休息）', 'daily', '飲食', 9, 1),
