...
-- 2. 午餐：新增銅，移除維他命 C
UPDATE plan_items SET
  description = '蛋白質 45-50g（正餐食物）+ 肌酸 5g + 十字花科蔬菜（切碎靜置 40 分鐘最大化蘿蔔硫素）+ 碳水 80-105g（訓練日）。脂肪：橄欖油 1 大匙（14g）+ 酪梨半顆（~15g）≈ 30g。魚油 3 顆、D3 2000IU（5+2）、K2（僅取 K2 引導鈣至骨骼）、葉黃素 20mg、膠原蛋白肽 10-15g、CoQ10 100-200mg（脂溶性，與魚油同服提升吸收）、B群 1 顆（水溶性，白天能量代謝）、銅 2mg（隨午餐正餐服用，利用食物體積緩衝腸胃刺激）。每日脂肪目標 50-70g（20-30% 總熱量）。不再額外沖乳清蛋白（正餐蛋白質已足夠）'
