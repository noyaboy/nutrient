  ...
  if (context === 'protein') {
    return (
      <div className="bg-amber-50 rounded-lg px-3 py-2 space-y-0.5 mt-1">
        ...
        <p className="text-amber-700 font-medium">強制將晚餐雞蛋移至 15:30 下午點心（蛋 6.3g + 豌豆 16g = 22.3g），晚餐蛋白質控制在 30-37.5g，守住單餐 ≤45g 上限</p>
      </div>
    );
  }
  ...
  if (context === 'egg') {
    return (
      <div className="bg-amber-50 rounded-lg px-3 py-2 space-y-0.5 mt-1">
        ...
        <p className="text-amber-700 font-medium">強制將雞蛋移至 15:30 下午點心（蛋 6.3g + 豌豆 16g = 22.3g），確保晚餐 ≤45g</p>
        <p className="text-amber-700">牛肉日取消鋅補劑：牛肉富含鋅 6-9mg/150g，當晚無需額外補鋅</p>
      </div>
    );
  }
