...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('09:15 訓練前營養', '香蕉 1 根 + 乳清蛋白 ~30g 粉（≈27g 蛋白）+ 肌酸 5g（溶於乳清一起沖泡）+ 奇亞籽 15g（~5g 纖維 + 2.5g ALA omega-3）。⚠️ 距訓練僅 45 分鐘，只吃流質乳清+好消化的香蕉+奇亞籽（先泡水 10 分鐘形成凝膠再加入乳清）。🔴 訓練日纖維補強：奇亞籽 15g（5g 纖維）+ 洋車前子殼 8-10g（6.4-8g）= 額外 11-13g 纖維，搭配蔬菜 5-8g 達標 35g+。地瓜需 60-90 分鐘消化，若要吃請提前至 08:00。⚠️ 堅果/種子請留至 15:30 下午點心（避免訓練前高脂延緩胃排空 + 保護午晚餐鐵吸收）', 'daily', '飲食', 3, 1, true),
  ...
  ('15:30 下午點心', 'Tryall 豌豆蛋白 22g 粉（≈16g 蛋白）+ 雞蛋 1 顆（牛肉日從晚餐移入）+ 🥜 綜合堅果 45g + 南瓜籽 30g + 核桃 15g + 葵花籽 15g（共 105g）。💊 16:00 服用鈣片 1 錠（500mg）——低鐵點心時段，不干擾任何礦物質吸收。⚠️ 堅果/種子全部集中於此時段：避免午餐/晚餐鋅（堅果 ~5mg）與鐵競爭 DMT1 轉運蛋白（同餐鋅抑制非血基質鐵吸收 30-50%）。⚠️ 訓練日改用此組合。休息日可改為燕麥 80g + 藍莓 50g + 堅果種子 105g。⚠️ 牛肉日：僅 1 顆蛋（6.3g 蛋白）+ 豌豆 16g = 22.3g', 'daily', '飲食', 11, 1, true),
  ('17:00 高質量社交對話', '至少與一位親友進行非公事的深度對話。每週安排 1 次面對面社交活動。戶外自然接觸 120+ 分鐘/週（可結合有氧）。哈佛研究：人際關係品質對壽命影響高於飲食與運動', 'daily', '心理', 12, 1, true),

  -- === Evening (19:00+) ===
  ('19:00 晚餐 + 低 FODMAP 蔬菜', '蛋白質 35-40g（單餐建議 ≤45g）+ 低 FODMAP 蔬菜（十字花科留給午餐）。順序：纖維→蛋白→碳水。隨餐服用：CoQ10 200mg + K2 100mcg（28g 橄欖油提供充足脂質）+ 維他命C 半錠 250mg（促進晚餐鐵吸收 + 覆蓋晚間需求）。⚠️ 鋅補劑已停用。晚餐避開全穀類植酸。💊 鈣片已移至 16:00（避免晚餐鈣抑制鐵吸收）。🔴 牛肉日：牛肉上限 150g，雞蛋分散至午餐+下午點心。⚠️ 膽鹼：每日至少 4 顆雞蛋或每日卵磷脂 1 大匙確保達 AI 550mg', 'daily', '飲食', 13, 1, true),
  ...
  ('22:30 睡前補充品', '甘胺酸 3g + 甘胺酸鎂 150mg（1.5 錠）+ Ashwagandha 450mg（KSM-66，嚴格 8 週用 / 4 週停）。洗完熱水澡後立即服用。💊 鈣片已移至 16:00 下午點心時段（避免鈣鎂競爭+晚餐鐵干擾）。⚠️ Magtein 144mg 在 09:15 服用（認知效益最佳化）。補充品鎂合計 ~294mg（甘胺酸鎂 150mg + 蘇糖酸鎂 144mg AM），安全低於 UL 350mg', 'daily', '補充品', 15, 1, true),
  ...
  ('全天 膳食纖維 35-45g', '洋蔥、大蒜、蘆筍、燕麥、扁豆、酪梨、冷卻米飯/地瓜（抗性澱粉）。搭配發酵食物（優格、泡菜 ≤30g/日）增強腸道多樣性。⚠️ 訓練日注意：低纖維碳水替換（白米/義大利麵/去皮馬鈴薯）可能使纖維降至 20-25g。訓練日補充：奇亞籽 15g（5g 纖維）+ 洋車前子殼 8-10g（6.4-8g 纖維）= 額外 11-13g，搭配蔬菜 5-8g 達標 35g+。🔴 葉酸保險：B群休息日（隔日無 B-complex），15:30 點心加入浸泡扁豆/鷹嘴豆 100g（~180mcg 葉酸 + 6-8g 纖維）——浸泡 8hr+ 可減少植酸 50-70%，確保每日葉酸 ≥400mcg DFE', 'daily', '飲食', 22, 1, true),
  ...
  ('全天 鈣攝取確認（目標 1000mg）', '每日確認鈣攝取是否達標 1000mg。主要來源：希臘優格 300g（必須，~280mg 鈣）+ 深綠蔬菜（~150-200mg）。🔴 每日 16:00 服用鈣片 1 錠（+500mg）——從晚餐移至 16:00 下午點心時段，避免晚餐鐵吸收被鈣抑制 50-60%。16:00 距午餐鐵已過 4hr（十二指腸吸收完畢），距睡前鎂 6.5hr（無競爭）。板豆腐日：優格 280mg + 板豆腐 150-225mg + 鈣片 500mg + 蔬菜 150mg ≈ 1080-1155mg ✅。非板豆腐日：優格 280mg + 鈣片 500mg + 蔬菜 150mg ≈ 930mg', 'daily', '飲食', 25, 1, true),
  ...
  ('全天 鐵吸收最佳化確認（目標 RDA 8mg）', '每日確認鐵吸收最佳化（男性 RDA 8mg）。🔴 鐵吸收促進因子：(1) 維他命C 午餐 500mg + 晚餐 250mg 隨餐（促進非血基質鐵吸收 2-6 倍）✅。(2) 動物蛋白「肉類因子」（MFP）促進鐵吸收。(3) 鈣片已移至 16:00 下午點心——午餐/晚餐鐵均不再被鈣抑制 ✅。(4) 堅果/種子移至 15:30——午餐/晚餐無鋅競爭 ✅。🔴 鐵吸收抑制因子：(1) 咖啡 09:15（午餐前 2.75hr+），影響 15-20%（搭配 VitC 500mg 淨正效益）✅。(2) 綠茶 15:00（午餐後 3hr+），影響有限 ✅。(3) 植酸：午餐使用白米。(4) 草酸（菠菜）：僅影響自身鐵。主要鐵來源：牛肉、雞蛋、菠菜、雞肝 2×/週 50g。⚠️ 每半年驗血清鐵蛋白 Ferritin 目標 50-150 ng/mL', 'daily', '飲食', 31, 1, true);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '碳酸鈣 + 檸檬酸鈣雙鈣源。每日 16:00 下午點心時段服用（從晚餐移出——鈣 500mg 抑制同餐非血基質鐵吸收 50-60%）。注意：本品含 D3 150IU/錠，與獨立 D3 2000IU 疊加後總計 2150IU 仍在安全範圍。K2 僅 10mcg/錠（不足日需量，已改用獨立 K2 MK-7 100mcg）',
  '每日 16:00 下午點心時段服用 1 錠（+500mg 鈣）。從晚餐 19:00 移至 16:00——避免晚餐鈣抑制鐵吸收 50-60%，且距睡前鎂 6.5hr 無競爭',
  'NT$759 / 250 錠',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '（每日必須）腰果、杏仁、開心果、夏威夷豆、巴西堅果。健康脂肪、鎂、鋅、維他命E、硒來源。🔴 份量：堅果 45g + 南瓜籽 30g + 核桃 15g + 葵花籽 15g = 共 ~105g/日。🟢 鋅補強：南瓜籽 30g 提供 ~2.5mg 鋅，確保非牛肉日鋅攝取 ≥11mg RDA。維他命E 修正：堅果 45g ~5.4mg + 葵花籽 15g ~5.3mg + 核桃 15g ~0.3mg + 橄欖油 42g ~5.9mg + 酪梨 ~0.7mg = ~17.6mg（搭配南瓜籽 30g ~0.6mg = ~18.2mg，達 RDA 15mg）。🔴 Omega-6 改善：葵花籽從 25-30g 減至 15g（減少 ~6.5g omega-6），核桃 15g 提供 ~1.3g ALA omega-3。🔴 鮭魚日嚴格禁止巴西堅果。⚠️ 巴西堅果嚴格 1 顆/日上限',
  '每日必須（堅果 45g + 南瓜籽 30g + 核桃 15g + 葵花籽 15g = ~105g）',
  'NT$599 / 1.13kg',
  ...
  '{}'::jsonb,
  '每日必須 ~105g。全部集中於 15:30 下午點心食用（避免午晚餐鋅鐵競爭）。線上可訂（常溫配送）。1.13kg 堅果約 3.5 週。另購：南瓜籽 500g + 核桃 500g + 葵花籽 500g（全聯/Costco）。🔴 鮭魚日跳過巴西堅果',
  11
);
