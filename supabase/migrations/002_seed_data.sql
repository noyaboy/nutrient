...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  -- === Midday (12:00-15:00) ===
  ('12:00 午餐 + 訓練後補充品', '蛋白質 35-40g（正餐完整蛋白質，⚠️ 不含膠原蛋白——膠原蛋白缺乏色胺酸與 BCAAs，非合成代謝等效蛋白質，僅作為結締組織修復補充）+ 蔬菜（建議使用白米或冷卻再加熱白米飯以減少植酸干擾鐵吸收）。隨餐服用：魚油 2 顆（鮭魚日 1 顆）、D3 2000IU（2 顆）、葉黃素 20mg、膠原蛋白肽 10-15g（額外，含 VitC ~120-160mg）、維他命C 500mg 1 錠（搭配鐵質食物最大化吸收）、B群 1 顆（⚠️ 隔日服用——P5P 50mg/日長期有周邊神經病變風險）。🔴 CoQ10 與 K2 已移至晚餐（28g 橄欖油提供更充足脂質微膠粒）。⚠️ 午餐搭配維他命C食物（彩椒、花椰菜）促進鐵吸收。⚠️ 堅果/種子請留至 15:30（避免鋅鐵 DMT1 競爭）', 'daily', '飲食', 7, 1, true),
  ...
  ('15:00 綠茶 EGCG 2-3 杯', '午餐後 3hr+ 再飲用（~15:00），高脂高蛋白午餐胃排空需 3-4hr，3hr 內 EGCG 仍會螯合鐵鋅。改用低咖啡因綠茶（白毫銀針或老白毫），天然 L-Theanine（40-90mg）+ EGCG 為下午專注紅利。15:30 前喝完（咖啡因 cutoff 統一 15:30）。🔴 下午僅喝綠茶，咖啡已移至 09:15 訓練前（避免下午咖啡干擾午餐鐵吸收）', 'daily', '飲食', 8, 1, true),
  ...
  -- === Evening (19:00+) ===
  ('19:00 晚餐 + 低 FODMAP 蔬菜', '蛋白質 35-40g（單餐建議 ≤45g）+ 低 FODMAP 蔬菜（十字花科留給午餐）。順序：纖維→蛋白→碳水。隨餐服用：CoQ10 200mg + K2 100mcg（28g 橄欖油提供充足脂質）+ 維他命C 半錠 250mg（促進晚餐鐵吸收 + 覆蓋晚間需求）。⚠️ 鋅補劑已停用。晚餐避開全穀類植酸。💊 鈣片已移至 17:30（距晚餐 1.5hr，避免鈣抑制鐵吸收）。🔴 牛肉日：牛肉上限 150g，雞蛋分散至午餐+下午點心。⚠️ 膽鹼：每日至少 4 顆雞蛋或牛肉日卵磷脂 1.5 大匙確保達 AI 550mg', 'daily', '飲食', 13, 1, true),
  ...
  ('22:30 睡前補充品', '甘胺酸 3g + 甘胺酸鎂 150mg（1.5 錠）+ Ashwagandha 450mg（KSM-66，嚴格 8 週用 / 4 週停）。洗完熱水澡後立即服用。💊 鈣片已移至 17:30（距睡前鎂 5hr，無鈣鎂競爭）。⚠️ Magtein 144mg 在 09:15 服用（認知效益最佳化）。補充品鎂合計 ~294mg（甘胺酸鎂 150mg + 蘇糖酸鎂 144mg AM），安全低於 UL 350mg', 'daily', '補充品', 15, 1, true),
  ...
  ('全天 鈣攝取確認（目標 1000mg）', '每日確認鈣攝取是否達標 1000mg。主要來源：希臘優格 300g（必須，~280mg 鈣）+ 深綠蔬菜（~150-200mg）。🔴 每日 17:30 服用鈣片 1 錠（+500mg）——距 15:30 堅果鋅 2hr（鋅吸收完畢），距 19:00 晚餐鐵 1.5hr（鈣片已離開腸道），距睡前鎂 5hr（無競爭）。板豆腐日：優格 280mg + 板豆腐 150-225mg + 鈣片 500mg + 蔬菜 150mg ≈ 1080-1155mg ✅。非板豆腐日：優格 280mg + 鈣片 500mg + 蔬菜 150mg ≈ 930mg', 'daily', '飲食', 25, 1, true),
  ...
  ('全天 膽鹼攝取確認（目標 AI 550mg）', '每日確認膽鹼攝取達 AI 550mg。主力來源：雞蛋 3-4 顆（~420-560mg，蛋黃為核心）。⚠️ 牛肉日雞蛋僅 2-3 顆（~280-420mg），需額外補充：卵磷脂 1.5 大匙（~180mg）確保達 AI 550mg。膽鹼對肝臟脂肪代謝、神經傳導、甲基化代謝至關重要。缺乏膽鹼可導致脂肪肝與肌肉損傷', 'daily', '飲食', 29, 1, true),
  ...
  ('全天 鐵吸收最佳化確認（目標 RDA 8mg）', '每日確認鐵吸收最佳化（男性 RDA 8mg）。🔴 鐵吸收促進因子：(1) 維他命C 午餐 500mg + 晚餐 250mg 隨餐（促進非血基質鐵吸收 2-6 倍）✅。(2) 動物蛋白「肉類因子」（MFP）促進鐵吸收。(3) 鈣片已移至 17:30——午餐/晚餐鐵均不再被鈣抑制 ✅。(4) 堅果/種子移至 15:30——午餐/晚餐無鋅競爭 ✅。🔴 鐵吸收抑制因子：(1) 咖啡 09:15（午餐前 2.75hr+），影響 15-20%（搭配 VitC 500mg 淨正效益）✅。(2) 綠茶 15:00（午餐後 3hr+），影響有限 ✅。(3) 植酸：午餐使用白米。(4) 草酸（菠菜）：僅影響自身鐵。主要鐵來源：牛肉、雞蛋、菠菜、雞肝 2×/週 50g。⚠️ 每半年驗血清鐵蛋白 Ferritin 目標 50-150 ng/mL', 'daily', '飲食', 31, 1, true);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '碳酸鈣 + 檸檬酸鈣雙鈣源。每日 17:30 服用（距 15:30 堅果鋅 2hr，距 19:00 晚餐鐵 1.5hr）。注意：本品含 D3 150IU/錠，與獨立 D3 2000IU 疊加後總計 2150IU 仍在安全範圍。K2 僅 10mcg/錠（不足日需量，已改用獨立 K2 MK-7 100mcg）',
  '每日 17:30 服用 1 錠（+500mg 鈣）。距 15:30 堅果鋅 2hr（鋅腸道吸收完畢），距 19:00 晚餐鐵 1.5hr（鈣片已離開腸道），距睡前鎂 5hr（無競爭）',
  'NT$759 / 250 錠',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '牛肉日 1.5 大匙（~15g, ~180mg 膽鹼）隨餐，或每日加入燕麥/優格',
  'NT$400-500 / 454g',
