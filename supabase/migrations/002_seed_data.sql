...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('22:00 睡前補充品', '甘胺酸 3g + 蘇糖酸鎂 + 甘胺酸鎂 100mg + Ashwagandha 450mg（KSM-66，嚴格 8 週用 / 4 週停，在瓶身標記開始日與第 56 天停用日）。22:30 洗完澡後服用', 'daily', '補充品', 15, 1, true),
  ...
  -- === All-day items ===
  ('全天 蛋白質 113-123g+（1.5-1.7g/kg）', '訓練前乳清 27g + 午餐 35-40g + 下午豌豆 16g + 晚餐 35-40g ≈ 113-123g。每餐 ≤45g，每日 4-5 餐均勻分配，總計約 1.5-1.7g/kg', 'daily', '飲食', 21, 1, true),
...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('晚餐 橄欖油 28g（2 大匙）',
   ...
   'daily', '脂肪', 28, 1, true),
  ('09:05 碘鹽 1g',
   '500ml 室溫水 + 碘鹽 1g（電子秤測量 0.1g 精度）+ 檸檬汁。碘鹽取代海鹽確保碘攝取。⚠️ 晨間碘鹽僅 1g 控鈉（WHO <2400mg/日），碘攝取主力仰賴午晚餐碘鹽 + 每週 2-3 次海帶/紫菜',
   'daily', '礦物質', 2, 1, true),
  ('藍莓 50g（抗氧化）',
