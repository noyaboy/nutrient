------------------------------------------------------------
-- 每日計畫項目 (24 active + 8 inactive = 32 items)
-- Matches live DB state as of 2026-03-02 (migrations 003-083 applied incrementally on live DB)
------------------------------------------------------------
...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('09:15 訓練前營養', '香蕉 1 根 + 乳清蛋白 ~30g 粉（≈27g 蛋白）+ 肌酸 5g（溶於乳清一起沖泡）+ 奇亞籽 15g（~5g 纖維 + 2.5g ALA omega-3）。⚠️ 距訓練僅 45 分鐘，只吃流質乳清+好消化的香蕉+奇亞籽（先泡水 10 分鐘形成凝膠再加入乳清）。🔴 訓練日纖維補強：奇亞籽 15g（5g 纖維）+ 洋車前子殼 5g（4g 纖維）= 額外 9g 纖維，搭配午餐前洋車前子殼 5g（4g）+ 蔬菜 5-8g 達標 35g+。地瓜需 60-90 分鐘消化，若要吃請提前至 08:00。⚠️ 堅果/種子請留至 15:30 下午點心（避免訓練前高脂延緩胃排空 + 保護午晚餐鐵吸收）', 'daily', '飲食', 3, 1, true),
  ...
  ('09:15 咖啡 + L-Theanine（訓練前）', '☕ 起床後 15 分鐘，搭配訓練前營養一起攝取。咖啡因 150-200mg + L-Theanine 200mg（1:1 A 級 nootropic 組合）。咖啡因 ~45-60 分鐘達峰，10:00 訓練時正好最佳狀態。✅ 距午餐 12:00 達 2.75hr+，咖啡多酚對午餐鐵吸收影響降至 15-20%（搭配 VitC 500mg 仍淨正效益）。✅ 距入睡 00:00 達 14.75hr（>5 個半衰期），咖啡因殘留 <5mg，對睡眠影響趨近零。⚠️ CAR（皮質醇覺醒反應）通常 30 分鐘內達峰——起床後 15 分鐘略早，但搭配 L-Theanine 可緩衝焦慮感。若感覺過度亢奮可延至 09:30', 'daily', '飲食', 3, 1, true),

  -- === Midday (12:00-15:00) ===
  ('12:00 午餐 + 訓練後補充品', '蛋白質 35-40g（正餐完整蛋白質，⚠️ 不含膠原蛋白——膠原蛋白缺乏色胺酸與 BCAAs，非合成代謝等效蛋白質，僅作為結締組織修復補充）+ 蔬菜（建議使用白米或冷卻再加熱白米飯以減少植酸干擾鐵吸收）。隨餐服用：魚油 2 顆（鮭魚日 1 顆）、D3 2000IU（2 顆）、葉黃素 20mg、膠原蛋白肽 10-15g（額外，含 VitC ~120-160mg）、維他命C 500mg 1 錠（搭配鐵質食物最大化吸收）、B群 1 顆（⚠️ 隔日服用——P5P 50mg/日長期有周邊神經病變風險）。🔴 CoQ10 與 K2 已移至晚餐（28g 橄欖油提供更充足脂質微膠粒）。✅ 午餐總脂肪約 20-25g（橄欖油 14g + 蛋/魚/肉脂肪），足以支持脂溶性 D3 與葉黃素吸收。⚠️ 午餐搭配維他命C食物（彩椒、花椰菜）促進鐵吸收。⚠️ 堅果/種子請留至 15:30（避免鋅鐵 DMT1 競爭）', 'daily', '飲食', 7, 1, true),
  ...
  ('15:00 綠茶 EGCG 2-3 杯', '午餐後 3hr+ 再飲用（~15:00），高脂高蛋白午餐胃排空需 3-4hr，3hr 內 EGCG 仍會螯合鐵鋅。改用低咖啡因綠茶（白毫銀針或老白毫），天然 L-Theanine（40-90mg）+ EGCG 為下午專注紅利。15:30 前喝完（咖啡因 cutoff 統一 15:30）。🔴 下午僅喝綠茶，咖啡已移至 09:15 訓練前（避免下午咖啡干擾午餐鐵吸收）。💊 15:00 同時服用 Magtein 蘇糖酸鎂 3 顆（144mg 元素鎂）——空腹無纖維/植酸/鈣競爭，吸收率最佳。Magtein 認知效益下午服用同樣有效（半衰期 ~12hr）', 'daily', '飲食', 8, 1, true),
  ...
  ('15:30 下午點心', 'Tryall 豌豆蛋白 22g 粉（≈16g 蛋白）+ 雞蛋 1 顆（牛肉日從晚餐移入）+ 🥜 綜合堅果 45g + 南瓜籽 35g + 核桃 15g + 葵花籽 15g（共 110g）。💊 17:00 服用鈣片 1 錠（500mg）——距堅果鋅 1.5hr（DMT1 轉運完畢），距晚餐鐵 2hr（鈣已離開腸道）。⚠️ 堅果/種子全部集中於此時段：避免午餐/晚餐鋅（堅果 ~5.5mg）與鐵競爭 DMT1 轉運蛋白（同餐鋅抑制非血基質鐵吸收 30-50%）。⚠️ 訓練日改用此組合。休息日可改為燕麥 80g + 藍莓 50g + 堅果種子 110g。⚠️ 牛肉日：僅 1 顆蛋（6.3g 蛋白）+ 豌豆 16g = 22.3g', 'daily', '飲食', 11, 1, true),
  ('17:00 高質量社交對話', '至少與一位親友進行非公事的深度對話。每週安排 1 次面對面社交活動。戶外自然接觸 120+ 分鐘/週（可結合有氧）。哈佛研究：人際關係品質對壽命影響高於飲食與運動', 'daily', '心理', 12, 1, true),

  -- === Evening (19:00+) ===
  ('19:00 晚餐 + 低 FODMAP 蔬菜', '蛋白質 35-40g（單餐建議 ≤45g）+ 低 FODMAP 蔬菜（十字花科留給午餐）。順序：纖維→蛋白→碳水。隨餐服用：CoQ10 200mg + K2 100mcg（28g 橄欖油提供充足脂質）+ 維他命C 半錠 250mg（促進晚餐鐵吸收 + 覆蓋晚間需求）。⚠️ 鋅補劑已停用。晚餐避開全穀類植酸。💊 鈣片已移至 17:00（距晚餐 2hr，避免鈣抑制鐵吸收）。🔴 牛肉日：牛肉上限 150g，雞蛋分散至午餐+下午點心。⚠️ 膽鹼：每日至少 4 顆雞蛋，或牛肉日卵磷脂 1.5 大匙 / 豆腐日卵磷脂 1 大匙，確保達 AI 550mg', 'daily', '飲食', 13, 1, true),
  ('19:30 餐後散步 15 分鐘', '控制餐後血糖最有效的方法，降低胰島素峰值。輕快步行即可，不需高強度。午餐後也建議散步 10-15 分鐘。可結合戶外自然接觸（每週目標 120+ 分鐘）', 'daily', '運動', 14, 1, true),
  ('22:00 睡前酪蛋白 20g', '💪 晚餐 19:00 至入睡 00:00 長達 5 小時無蛋白質攝入，錯失夜間肌肉蛋白合成窗口。睡前 1-2 小時服用酪蛋白（casein）20g，緩釋氨基酸維持整夜 MPS。📋 首選酪蛋白粉 20g 沖泡（鈣含量僅 ~60-100mg，不干擾 22:30 鎂吸收）。次選希臘優格 200g（~180mg 鈣，建議提前至 21:30 服用，拉開與鎂的間隔至 60 分鐘）。⚠️ 與睡前補充品（甘胺酸+鎂）間隔 30-60 分鐘。蛋白質總量更新：訓練前 27g + 午餐 41-44g + 下午 16g + 晚餐 38-45g + 睡前 20g ≈ 142-152g（1.9-2.1g/kg）', 'daily', '飲食', 16, 1, true),
  ('22:30 睡前補充品', '甘胺酸 3g + 甘胺酸鎂 150mg（1.5 錠）+ Ashwagandha 450mg（KSM-66，嚴格 8 週用 / 4 週停）。洗完熱水澡後立即服用。💊 鈣片已移至 17:00（距睡前鎂 5.5hr，無鈣鎂競爭）。⚠️ Magtein 144mg 已移至 15:00 隨綠茶服用（空腹無競爭礦物質，認知效益最佳化）。補充品鎂合計 ~294mg（甘胺酸鎂 150mg + 蘇糖酸鎂 144mg PM），安全低於 UL 350mg', 'daily', '補充品', 15, 1, true),
  ...
  -- === All-day items ===
  ('全天 蛋白質 136-148g+（1.9-2.0g/kg）', '訓練前乳清 27g + 午餐 35-40g（不含膠原蛋白）+ 下午豌豆 16g + 晚餐 38-45g + 睡前酪蛋白 20g ≈ 136-148g。每餐 ≤45g，每日 5 餐均勻分配。⚠️ 膠原蛋白 10-15g 為額外結締組織修復用途，不計入合成代謝蛋白質目標。🔴 睡前酪蛋白（22:00）填補 19:00-08:00 長達 13hr 的蛋白質斷層，多項 RCT 證實睡前酪蛋白顯著提升夜間肌肉蛋白合成率', 'daily', '飲食', 21, 1, true),
  ('全天 膳食纖維 35-45g', '洋蔥、大蒜、蘆筍、燕麥、扁豆、酪梨、冷卻米飯/地瓜（抗性澱粉）。搭配發酵食物（優格、泡菜 ≤30g/日）增強腸道多樣性。⚠️ 訓練日注意：低纖維碳水替換（白米/義大利麵/去皮馬鈴薯）可能使纖維降至 20-25g。訓練日補充：奇亞籽 15g（5g 纖維）+ 洋車前子殼 5g 早上 + 5g 午餐前（共 8g 纖維）= 額外 13g，搭配蔬菜 5-8g 達標 35g+。🔴 葉酸保險：B群休息日（隔日無 B-complex），15:30 點心加入浸泡扁豆/鷹嘴豆 100g（~180mcg 葉酸 + 6-8g 纖維）——浸泡 8hr+ 可減少植酸 50-70%，確保每日葉酸 ≥400mcg DFE', 'daily', '飲食', 22, 1, true),
  ('全天 每 45 分鐘站立/坐姿切換', '維持脂蛋白脂肪酶 LPL 活性，避免久坐代謝下降', 'daily', '運動', 23, 1, true),
  ('全天 碳水循環：訓練日 vs 休息日', '重訓日 5-7g/kg (360-510g)、有氧日 3-4g/kg (215-290g)、休息日 3-3.5g/kg (220-255g)。重訓日熱量目標 3,100-3,400 kcal、休息日目標 2,400-2,600 kcal。⚠️ 休息日碳水不可低於 3g/kg——低於此值造成每週熱量赤字（TDEE ~2,960 kcal/日），無法達成增肌目標 +0.5-1kg/月。⚠️ 高碳水日嚴格執行低纖維替換', 'daily', '飲食', 24, 1, true),
  ...
  ('全天 鈣攝取確認（目標 1000mg）', '每日確認鈣攝取是否達標 1000mg。主要來源：希臘優格 300g（必須，~280mg 鈣）+ 深綠蔬菜（~150-200mg）。🔴 每日 17:00 服用鈣片 1 錠（+500mg）——距 15:30 堅果鋅 1.5hr（鋅吸收完畢），距 19:00 晚餐鐵 2hr（鈣片已離開腸道），距睡前鎂 5.5hr（無競爭）。板豆腐日：優格 280mg + 板豆腐 150-225mg + 鈣片 500mg + 蔬菜 150mg ≈ 1080-1155mg ✅。非板豆腐日：優格 280mg + 鈣片 500mg + 蔬菜 150mg ≈ 930mg', 'daily', '飲食', 25, 1, true),
  ('全天 飲水 3-3.5L', '尿液淡黃色為適當水合指標。💧 補鈣日飲水目標 3.5L+（維持良好水合，支持腎臟代謝）', 'daily', '飲食', 26, 1, true),
  ('全天 維他命A攝取確認（目標 900mcg RAE）', '每日確認維他命A攝取。主要來源：橘色地瓜 100g（~700mcg RAE β-胡蘿蔔素）+ 雞蛋 3-4 顆（~270-360mcg RAE）+ 雞肝 2×/週 50g（~5,500mcg RAE/次，攤平 ~1,571mcg/日）= 週均 ~2,271-2,631mcg RAE/日（安全低於 UL 3000mcg）。⚠️ 地瓜必須選橘色品種（台農 57 號）。搭配油脂烹調（β-胡蘿蔔素為脂溶性）。無地瓜日可用胡蘿蔔 50g（~400mcg RAE）替代', 'daily', '飲食', 27, 1, true),
  ('全天 鉀攝取確認（目標 3800-4000mg）', '每日確認鉀攝取達 3800-4000mg。主力來源：酪梨半顆（~350mg）+ 馬鈴薯 1 顆（~800mg）+ 香蕉 1 根（~400mg）+ 希臘優格 300g（~300mg）+ 菠菜/蔬菜（~400mg）+ 鮭魚/肉類（~400mg）+ 地瓜 100g（~300mg）+ 椰子水 330ml（~600mg）+ 其他（~300mg）≈ 3,850-4,150mg ✅。⚠️ 酪梨、馬鈴薯、椰子水為核心三件，缺一不可', 'daily', '飲食', 28, 1, true),
  ('全天 膽鹼攝取確認（目標 AI 550mg）', '每日確認膽鹼攝取達 AI 550mg。主力來源：雞蛋 3-4 顆（~420-560mg，蛋黃為核心）。⚠️ 牛肉日雞蛋僅 2-3 顆（~280-420mg），需額外補充：卵磷脂 1.5 大匙（~180mg）確保達 AI 550mg。⚠️ 豆腐日 / 低膽鹼蛋白日（雞蛋 <4 顆且非雞肉/鮭魚）：卵磷脂 1 大匙（~120mg）補足缺口。膽鹼對肝臟脂肪代謝、神經傳導、甲基化代謝至關重要。缺乏膽鹼可導致脂肪肝與肌肉損傷', 'daily', '飲食', 29, 1, true),
  ('訓練日 洋車前子殼 5g（纖維補充）', '重訓日低纖維碳水替換（白米/義大利麵/去皮馬鈴薯）會使膳食纖維降至 20-25g，距目標 35g+ 缺口 10-15g。09:15 訓練前洋車前子殼 5g（4g 纖維）+ 午餐前洋車前子殼 5g（4g 纖維）= 共 8g 額外纖維。⚠️ 每次必須搭配充足水分（250ml+），否則可能引起腸阻塞。⚠️ 僅訓練日使用——休息日正常飲食纖維已達標 35g+，無需額外補充', 'daily', '飲食', 23, 1, true),
  ...
  ('全天 鐵吸收最佳化確認（目標 RDA 8mg）', '每日確認鐵吸收最佳化（男性 RDA 8mg）。🔴 鐵吸收促進因子：(1) 維他命C 午餐 500mg + 晚餐 250mg 隨餐（促進非血基質鐵吸收 2-6 倍）✅。(2) 動物蛋白「肉類因子」（MFP）促進鐵吸收。(3) 鈣片已移至 17:00——午餐/晚餐鐵均不再被鈣抑制（距晚餐 2hr）✅。(4) 堅果/種子移至 15:30——午餐/晚餐無鋅競爭 ✅。🔴 鐵吸收抑制因子：(1) 咖啡 09:15（午餐前 2.75hr+），影響 15-20%（搭配 VitC 500mg 淨正效益）✅。(2) 綠茶 15:00（午餐後 3hr+），影響有限 ✅。(3) 植酸：午餐使用白米。(4) 草酸（菠菜）：僅影響自身鐵。主要鐵來源：牛肉、雞蛋、菠菜、雞肝 2×/週 50g。⚠️ 每半年驗血清鐵蛋白 Ferritin 目標 50-150 ng/mL', 'daily', '飲食', 31, 1, true);
...
INSERT INTO plan_items (title, description, frequency, category, sort_order, target_count, is_active) VALUES
  ...
  ('鋅 15mg 每日補充', '⛔ 已停用（2026-03-01 營養審查）。飲食鋅已達 10-15mg/日（雞蛋 ~5mg + 肉類 ~5-12mg + 堅果 ~2-3mg），超過 RDA 11mg。額外補充 15mg 使總計達 25-30mg（接近 UL 40mg），鋅銅比 21-30:1（最佳 8-15:1）。長期高鋅誘導腸道金屬硫蛋白優先結合銅，導致銅缺乏性貧血、白血球低下、神經病變。⚠️ 每半年驗血清鋅+銅+銅藍蛋白，若血清鋅 <70mcg/dL 才考慮恢復補充', 'daily', '補充品', 27, 1, false);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每 1200mg 魚油含 Omega-3 約 700mg（EPA 419mg + DHA 281mg）。沙丁魚、鯷魚、鯖魚來源，緩釋不打嗝。產地加拿大。🔴 從 3 顆降至 2 顆/日——EPA+DHA 1400mg 已覆蓋心血管保護與抗發炎效益（VITAL 試驗支持 840mg+），>2000mg/日額外效益有限但出血風險增加',
  '每日隨餐 2 顆（EPA+DHA 共 1400mg）。⚠️ 鮭魚日減為 1 顆（700mg + 鮭魚 ~1200mg ≈ 1900mg）。從 3 顆降至 2 顆——EPA+DHA 效益在 1500-2000mg 趨於平穩',
  'NT$579 / 180 顆',
  ...
  '線上可訂（常溫配送）。每日 2 顆，180 顆可用 3 個月。⚠️ 開瓶後必須冷藏（2-8°C），每次取用後迅速旋緊瓶蓋。📋 在瓶身標註開瓶日期，開瓶後 60 天內用完。⚠️ 有腥味或苦味表示已氧化變質，立即丟棄。',
  1
);

INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  '鈣片備用（Nature Made Ca+D3+K2 250 錠）',
  '碳酸鈣 + 檸檬酸鈣雙鈣源。每日 17:00 服用（距 15:30 堅果鋅 1.5hr，距 19:00 晚餐鐵 2hr）。注意：本品含 D3 150IU/錠，與獨立 D3 2000IU 疊加後總計 2150IU 仍在安全範圍。K2 僅 10mcg/錠（不足日需量，已改用獨立 K2 MK-7 100mcg）',
  '每日 17:00 服用 1 錠（+500mg 鈣）。距 15:30 堅果鋅 1.5hr（鋅腸道吸收完畢），距 19:00 晚餐鐵 2hr（鈣片已離開腸道），距睡前鎂 5.5hr（無競爭）',
  'NT$759 / 250 錠',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每日 Vit C 補充。🔴 分時服用最大化吸收：午餐 1 錠（500mg，搭配鐵質食物促進吸收 2-6 倍）+ 晚餐半錠（250mg，覆蓋晚餐鐵吸收需求）。膠原蛋白日午餐已含 VitC 120-160mg，仍建議服用 1 錠以確保鐵吸收最佳化。⚠️ 切半錠備晚餐用——500mg 錠劑用切藥器對半切開，半錠隨晚餐服用。Vit C 半衰期 ~2hr，分次服用維持血中濃度',
  '午餐 1 錠（500mg）+ 晚餐半錠（250mg）。每日共 750mg，分 2 次服用',
  'NT$250-350 / 100 錠',
  ...
  'iHerb 直送。每日 1.5 錠（750mg 分 2 次），100 錠約 2 個月。需切藥器切半。開瓶後標記日期，6 個月內用完。',
  3
);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '{}'::jsonb,
  '每日必須 ~110g。全部集中於 15:30 下午點心食用（避免午晚餐鋅鐵競爭）。線上可訂（常溫配送）。1.13kg 堅果約 3.5 週。另購：南瓜籽 500g + 核桃 500g + 葵花籽 500g（全聯/Costco）。🔴 鮭魚日跳過巴西堅果',
  11
);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  '咖啡豆 / 研磨咖啡',
  '訓練前飲用，咖啡因 150-200mg + L-Theanine 200mg（A 級 nootropic 組合）。多酚抗氧化、增強專注力。距午餐 2.75hr+，鐵吸收影響極低',
  '每日 1-2 杯，09:15 訓練前（搭配 L-Theanine 200mg）',
  '~NT$399 / 1.13kg',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每日下午 15:00-15:30 綠茶 2-3 杯（咖啡已移至早晨）',
  '~NT$200-400',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '睡前 1.5 錠（150mg）。與蘇糖酸鎂 144mg（15:00 服用）合計補充品鎂 294mg，安全低於 UL 350mg',
  'NT$399 / 180 錠',
  ...
  $${"serving_size":"1.5錠","magnesium":"150mg（提取自1500mg甘氨酸鎂）"}$$::jsonb,
  'iHerb 直送。每日 1.5 錠（150mg），180 錠可用 4 個月。與蘇糖酸鎂（每月補貨）合併 iHerb 訂購節省運費。',
  23
);
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '⛔ 已停用（2026-03-01 營養審查）。飲食鋅已達 10-15mg/日（雞蛋 ~5mg + 肉類 ~5-12mg + 堅果 ~2-3mg），超過 RDA 11mg。額外補充 15mg 使總計達 25-30mg（接近 UL 40mg），鋅銅比過高。⚠️ 每半年驗血清鋅，若 <70mcg/dL 才考慮恢復補充。保留產品供參考',
  '⛔ 已停用。飲食鋅已達 RDA 11mg，無需額外補充',
  'NT$250-350 / 120 錠',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '獨立 K2 MK-7（納豆來源），引導鈣質沉積至骨骼而非血管壁。與 D3 協同作用，防止動脈鈣化。🔴 已移至晚餐（19:00，搭配 28g 橄欖油）——午餐僅 14g 橄欖油，晚餐 28g 提供更充足脂質微膠粒，脂溶性維生素吸收提升 30-50%',
  '每日 1 顆隨晚餐（19:00）服用——從午餐移至晚餐，28g 橄欖油提供更充足脂質載體提升脂溶性 K2 吸收。MK-7 半衰期 ~72hr，每日 1 次即可',
  'NT$887 / 120 顆',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每日 1 顆（200mg）09:15 隨咖啡服用。下午綠茶另含天然 L-Theanine 40-90mg 為額外紅利',
  'NT$399 / 120 顆',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每日 1 顆隨 19:00 晚餐（搭配 28g 橄欖油增強脂溶性吸收）',
  'NT$1,109 / 60 顆',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, image_url, rating, review_count, sku, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '每日 3 顆（元素鎂 ~144mg），15:00 隨綠茶服用。空腹無纖維/植酸/鈣干擾，吸收率最佳',
  'NT$874 / 90 顆',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '向日葵卵磷脂（非大豆），富含磷脂醯膽鹼（Phosphatidylcholine）。牛肉日膽鹼補充主力，每大匙（~10g）含 ~120mg 膽鹼。牛肉日用 1.5 大匙（~180mg 膽鹼）確保達 AI 550mg。非基改、無大豆過敏風險',
  '牛肉日 1.5 大匙（~15g, ~180mg 膽鹼）隨餐。豆腐日或低膽鹼蛋白日（雞蛋 <4 顆且非雞肉/鮭魚）1 大匙（~10g, ~120mg 膽鹼）。或每日加入燕麥/優格',
  'NT$400-500 / 454g',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES (
  ...
  '訓練日 09:15 5g + 午餐前 5g，各沖 250ml 水',
  'NT$250-350 / 340g',
...
INSERT INTO products (name, description, usage, price, url, store, category, brand, origin, specs, nutrition, purchase_note, sort_order) VALUES
  ...
  ('雞肝（傳統市場/超市）',
   ...
   'NT$40-60 / 300g',
   'https://www.pxmart.com.tw',
   '傳統市場 / 全聯', 'convenience_daily', NULL, '台灣',
   '{"storage":"冷藏 1-2 天，買當天料理最佳","portion":"每次 50g（電子秤量測）"}'::jsonb,
  ...
  ('椰子水（Vita Coco / Kirkland 330ml）',
   ...
   'Costco / 全聯 / 便利超商', 'convenience_daily', NULL, NULL,
   '{}'::jsonb,
